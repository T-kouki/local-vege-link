...
urlpatterns = [
    ...
    path("farm/product_manage/", views.product_manage_view, name="farm_product_manage"),
    path("admin/product_manage/", views.product_manage_view, name="admin_product_manage"),
